...
| 平台 | 下载 | 使用方式 |
|---|---|---|
| **Windows** | [EasyNote.exe](https://github.com/lvmaizi/easy-note/releases/edit/0.0.1) | 双击 `EasyNote.exe` |
| macOS | [EasyNote.dmg](https://github.com/lvmaizi/easy-note/releases/edit/0.0.1) | 打开 dmg，把 `EasyNote.app` 拖到「应用程序」；首次打开需执行下方命令 |
...
1. 下载上方 [EasyNote](https://github.com/your-name/easy-note/releases/edit/0.0.1) 
2. 双击 `EasyNote` 启动；
